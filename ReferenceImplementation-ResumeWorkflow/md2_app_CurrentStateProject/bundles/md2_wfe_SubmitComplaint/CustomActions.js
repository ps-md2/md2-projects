define([
    ...
    "./actions/__processChainSetProcessChainComplaintProcessChainAction"
],
function(
    declare,
    init,
    ...
    __processChainSetProcessChainComplaintProcessChainAction
) {
    ...
    return declare([], {
        ...
        createInstance: function() {
            return [
                ...
                new __processChainSetProcessChainComplaintProcessChainAction()
            ];
        }
